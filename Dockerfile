...
# `-i max`: Instructs PM2 to launch the application in cluster mode, utilizing the
#           maximum number of available CPU cores. This improves performance and resilience.
